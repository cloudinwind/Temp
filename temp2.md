```bash
aosp_master grep -rn "setVolumes\|setMasterVolume\|setMasterMute\|getMasterVolume\|Mixer" \
  hardware/interfaces/audio/aidl/default/Module.cpp \
  hardware/interfaces/audio/aidl/default/primary/ \
  2>/dev/null | head -60
hardware/interfaces/audio/aidl/default/Module.cpp:1465:ndk::ScopedAStatus Module::setMasterMute(bool in_mute) {
hardware/interfaces/audio/aidl/default/Module.cpp:1480:ndk::ScopedAStatus Module::getMasterVolume(float* _aidl_return) {
hardware/interfaces/audio/aidl/default/Module.cpp:1486:ndk::ScopedAStatus Module::setMasterVolume(float in_volume) {
hardware/interfaces/audio/aidl/default/Module.cpp:1733:ndk::ScopedAStatus Module::getAAudioMixerBurstCount(int32_t* _aidl_return) {
hardware/interfaces/audio/aidl/default/primary/PrimaryMixer.cpp:17:#define LOG_TAG "AHAL_PrimaryMixer"
hardware/interfaces/audio/aidl/default/primary/PrimaryMixer.cpp:19:#include "PrimaryMixer.h"
hardware/interfaces/audio/aidl/default/primary/PrimaryMixer.cpp:24:PrimaryMixer& PrimaryMixer::getInstance() {
hardware/interfaces/audio/aidl/default/primary/PrimaryMixer.cpp:25:    static PrimaryMixer gInstance;
hardware/interfaces/audio/aidl/default/primary/StreamPrimary.cpp:223:        RETURN_STATUS_IF_ERROR(primary::PrimaryMixer::getInstance().getMicGain(&gain));
hardware/interfaces/audio/aidl/default/primary/StreamPrimary.cpp:240:    if (auto status = primary::PrimaryMixer::getInstance().setMicGain(in_channelGains[0]);
hardware/interfaces/audio/aidl/default/primary/StreamPrimary.cpp:246:    RETURN_STATUS_IF_ERROR(primary::PrimaryMixer::getInstance().getMicGain(&gain));
hardware/interfaces/audio/aidl/default/primary/StreamPrimary.cpp:267:        RETURN_STATUS_IF_ERROR(primary::PrimaryMixer::getInstance().getVolumes(_aidl_return));
hardware/interfaces/audio/aidl/default/primary/StreamPrimary.cpp:281:    if (auto status = primary::PrimaryMixer::getInstance().setVolumes(in_channelVolumes);
hardware/interfaces/audio/aidl/default/primary/StreamPrimary.cpp:287:    RETURN_STATUS_IF_ERROR(primary::PrimaryMixer::getInstance().getVolumes(&volumes));
hardware/interfaces/audio/aidl/default/primary/PrimaryMixer.h:19:#include "alsa/Mixer.h"
hardware/interfaces/audio/aidl/default/primary/PrimaryMixer.h:23:class PrimaryMixer : public alsa::Mixer {
hardware/interfaces/audio/aidl/default/primary/PrimaryMixer.h:30:    static PrimaryMixer& getInstance();
hardware/interfaces/audio/aidl/default/primary/PrimaryMixer.h:33:    PrimaryMixer() : alsa::Mixer(kAlsaCard) {}
```

ModulePrimary.cpp

```bash
aosp_master cat hardware/interfaces/audio/aidl/default/ModulePrimary.cpp
/*
